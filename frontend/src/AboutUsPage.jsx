...
import mapster_logo_white from "../assets/mapster_logo_white.png";
    ...
    <div className="about-container">
      ...
      <div className="about-wrapper">
        ...
        <p className="about-desc">
          ...
          algorithm to determine the shortest route between the user's current position and the selected destination. With a clean user
          interface and GPS-independent functionality, MAPSTER ensures a seamless and reliable navigation experience. It is built to assist
          visitors, staff, and students in navigating complex layouts with ease and confidence.
        </p>
